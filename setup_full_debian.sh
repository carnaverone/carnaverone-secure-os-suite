...
# Script: setup_full_debian.sh
# Purpose: Automate the installation of a secure development environment on Debian-based systems.

echo "Starting setup for Debian..."
