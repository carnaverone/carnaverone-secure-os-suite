...
# ========================
echo "📦 Installation des outils de base (base-devel, curl, wget, etc.)" | tee -a $LOG_FILE 2>&1
sudo pacman -Syu --noconfirm
sudo pacman -S --noconfirm base-devel curl wget git vim nano unzip zip htop neofetch net-tools
...
sudo pacman -S --noconfirm espeak festival flite
...
sudo pacman -S --noconfirm virtualbox qemu libvirt virt-manager
...
sudo pacman -S --noconfirm ufw fail2ban apparmor audit rkhunter chkrootkit lynis
